  ...
  // Top-level MIME helper usable from other widgets in this file
  ...
  // ============ VIEW PROPOSAL MODAL ============
  // ============ VIEW PROPOSAL MODAL (COMPLETELY FIXED) ============
  class _ViewProposalModal extends StatelessWidget {
    ...
    // ✅ FIXED: Static method para ma-access sa loob ng class
    ...
    // ✅ FIXED VERSION - with proper mounted checks and static method call
    Future<void> _handleAndPreviewAttachment(BuildContext context, Map<String, dynamic> data, 
      ...
      try {
        ...
        // ✅ FIXED: Use static method from the class
        final mime = _ViewProposalModal._mimeFromExtension(ext);

        // Display inline for common types
        ...
        // PDFs and other binaries: open/download
