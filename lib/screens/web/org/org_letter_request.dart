...
class _OrgLetterRequestScreenState extends State<OrgLetterRequestScreen> {
  ...
  List<LetterRequestModel> _applyFilters(List<LetterRequestModel> requests) {
    var filtered = requests;
    
    if (_statusFilter != 'All') {
      filtered = filtered.where((r) => r.status == _statusFilter.toLowerCase()).toList();
    }
    
    if (_searchQuery.isNotEmpty) {
      filtered = filtered.where((r) =>
        r.letterId.toLowerCase().contains(_searchQuery.toLowerCase()) ||
        r.subject.toLowerCase().contains(_searchQuery.toLowerCase())
      ).toList();
    }
        ...
        builder: (context, snapshot) {
          ...
          return Column(
            ...
            children: [
              ...
              const SizedBox(height: 20),
              Expanded(child: _buildTableCard(filtered)),
            ],
          );
        },
      ),
  ...
  Widget _buildStats(List<LetterRequestModel> all) {
    ...
    final types    = all.map((r) => r.letterType ?? 'General').toSet().length;
  ...
  Widget _buildTableCard(List<LetterRequestModel> filtered) {
    return Container(
      decoration: BoxDecoration(
        color: OrgColors.white,
        borderRadius: BorderRadius.circular(12),
            ...
            child: filtered.isEmpty
                ...
                : SingleChildScrollView(
                    ...
                    child: DataTable(
                      ...
                      rows: filtered.map((req) => DataRow(cells: [
                        DataCell(
                          InkWell(
          ...
          children: [
            ...
            if (request.revisionCount != null && request.revisionCount! > 0) ...[
              ...
              Container(
                padding: const EdgeInsets.all(12),
                decoration: BoxDecoration(
                  color: OrgColors.mediumGray.withValues(alpha: 0.2),
                  borderRadius: BorderRadius.circular(8),
                ),
                child: Row(children: [
...
class _LetterRequestModalState extends State<_LetterRequestModal> {
      ...
      children: [
        ...
        AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: _isUploading
                  ? OrgColors.primaryDark.withValues(alpha: 0.4)
    ...
    return GestureDetector(
      ...
      child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
        Container(
          ...
          decoration: BoxDecoration(color: OrgColors.primaryDark.withValues(alpha: 0.08), borderRadius: BorderRadius.circular(8)),
      ...
      children: [
        Row(children: [
          Container(
            ...
            decoration: BoxDecoration(color: OrgColors.primaryDark.withValues(alpha: 0.08), borderRadius: BorderRadius.circular(6)),
  ...
  Widget _buildUploadedState() {
    return Row(children: [
      Container(
        padding: const EdgeInsets.all(8),
        decoration: BoxDecoration(color: OrgColors.success.withValues(alpha: 0.1), borderRadius: BorderRadius.circular(8)),
