...
// Same visual language as AdminLandingPage / OrganizationLogin: campus photo
// backdrop + vignette, frosted-glass card — with the green accent kept so
// this still reads as the Org portal rather than Admin. Navigation logic
// is unchanged.

class OrgLandingPage extends StatelessWidget {
  ...
  Widget _buildLeft(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          child: Text('ORGANIZATION ACCESS',
              style: GoogleFonts.beVietnamPro(
                ...
                color: _rustDeep, letterSpacing: 1.2)),
        ),
        ...
        Text(
          'Access your organization dashboard, manage events, and track reports from one place.',
          style: GoogleFonts.beVietnamPro(
            fontSize: 15,
            color: _slateMid,
            height: 1.6,
        ...
        Row(mainAxisSize: MainAxisSize.min, children: [
          ...
          Text(
            'Built for officers and organization representatives.',
            style: GoogleFonts.beVietnamPro(
              fontSize: 12.5,
              color: _slateSoft,
            ),
      ...
      child: Column(
        ...
        children: [
          _FeatureTile(
            ...
            title: 'Plan events',
            subtitle: 'Create and manage organization activities.',
          ),
          const SizedBox(height: 14),
          _FeatureTile(
            icon: Icons.receipt_long_rounded,
            title: 'Submit reports',
            subtitle: 'Handle financial and accomplishment submissions.',
          ),
          const SizedBox(height: 14),
          _FeatureTile(
            icon: Icons.people_alt_rounded,
            title: 'Engage members',
            subtitle: 'Keep your organization connected and organized.',
          ),
        ],
      ),
    );
    ...
    return Row(
      ...
      children: [
        Container(
          ...
          child: Icon(icon, color: _accentDeep, size: 20),
        ),
