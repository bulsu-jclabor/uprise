...
class _EventCalendarState extends State<EventCalendar> {
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          // ---------- TOOLBAR (filter dropdown + export) ----------
          Padding(
  ...
  Future<void> _showAddEventDialog() async {
    // Simple placeholder – you can implement a full form later
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('Add Event feature – create a form dialog similar to Event Proposals')),
    );
  }
